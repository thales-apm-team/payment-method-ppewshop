package com.payline.payment.ppweshop.service;

import com.payline.payment.ppweshop.MockUtils;
...
class LogoPaymentFormConfigurationServiceTest {
    ...
    void getPaymentFormLogo_nominal(){
        ...
        doReturn( "PPWEShop" ).when( i18n ).getMessage("paymentMethod.name", paymentFormLogoRequest.getLocale() );
        ...
        assertTrue( ((PaymentFormLogoResponseFile) logoResponse).getTitle().contains("PPWEShop") );
        assertTrue( ((PaymentFormLogoResponseFile) logoResponse).getAlt().contains("PPWEShop") );
    }
