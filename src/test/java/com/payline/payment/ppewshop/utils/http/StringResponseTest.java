...
class StringResponseTest {
    ...
    void fromHttpResponse_nominal() {
        ...
        CloseableHttpResponse httpResponse = MockUtils.mockHttpResponse(200, "OK", "some content",
    ...
    void toStringMethod() {
        ...
        StringResponse stringResponse = MockUtils.mockStringResponse(400, "Bad Request", jsonContent, headers);
