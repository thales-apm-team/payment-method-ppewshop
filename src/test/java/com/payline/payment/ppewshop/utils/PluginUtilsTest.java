...
class PluginUtilsTest {
    ...
    private static Stream<Arguments> category_set() {
        return Stream.of(
                ...
                Arguments.of("5", "663"),
                Arguments.of("50001", "733"),
                Arguments.of("500010001", "733"),
                Arguments.of("50002", "663"),
                Arguments.of("50003", "663"),
                Arguments.of("500030001", "663"),
                Arguments.of("50004", "663"),
                Arguments.of("500040001", "663"),
                Arguments.of("500040002", "663"),
                Arguments.of("500040003", "663"),
                Arguments.of("500040004", "663"),
                Arguments.of("599990001", "343"),
                Arguments.of("599990002", "343"),
                Arguments.of("6", "640"),
                Arguments.of("7", "660"),
                Arguments.of("8", "730"),
                Arguments.of("9", "660"),
                Arguments.of("10", "660"),
                Arguments.of("11", "todo"),
                Arguments.of("110001", "todo"),
                Arguments.of("12", "330"),
                Arguments.of("120001", "330"),
                ...
                Arguments.of("13", "todo"),
                Arguments.of("14", "660"),
                Arguments.of("15", "660"),
                Arguments.of("16", "todo"),
                Arguments.of("17", "todo"),
                Arguments.of("170001", "todo"),
                Arguments.of("170002", "todo"),
                Arguments.of("18", "660"),
                Arguments.of("19", "660"),
                Arguments.of("20", "631"),
                Arguments.of("21", "todo"),
                Arguments.of("22", "todo"),
                Arguments.of("23", "todo"),
                Arguments.of("24", "858"),
                Arguments.of("240001", "858"),
                Arguments.of("2400010001", "855"),
                Arguments.of("2400010002", "Orgue"),
                Arguments.of("25", "650"),
                Arguments.of("26", "620"),
                Arguments.of("XXXXX", "todo")
        );
    }
